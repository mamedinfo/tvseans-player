    ...
    n = {
        ...
        const T = function (e) {
          ...
          Z = (e) =>
            A(e)
              ...
              : P(e)
                  .then(() => {
                    if (e.get("drm") || (0, O.w0)(e.get("playlist")))
                      return (0, O.lD)(e.get("edition"));
                  })
                  .then(() => {
                    return P((t = e)).then(() => {
                      if (x(t)) return;
          ...
          h = (e, t, n) => {
            ...
            if (
              ...
              return (
                ...
                (a.feedData = n),
                (a.starttime =
                  -1 !== s && e.get("generateSEOMetadata") ? s : a.starttime),
                ((e) => {
              ...
              (t[1].includes("#") ? t[1].split("#")[0] : t[1])
                ...
                .forEach((e) => {
                  ...
                  !(function (e, t) {
                    ...
                    ? (n[t] = i)
                    : (Array.isArray(n[t]) || (n[t] = [n[t]]), n[t].push(i));
                }),
              n
            );
          },
      ...
      9888: (e, t, n) => {
        ...
        const o = (e) => /^(?:(?:https?|file):)?\/\//.test(e),
          s = (e, t) => {
            if (
              ((t && (0, r.exists)(t)) || (t = document.location.href),
              !(0, r.exists)(e))
            )
              return "";
            if (o(e)) return e;
            ...
            if (0 === e.indexOf("/")) s = e.split("/");
              ...
              let r = t.split("?")[0];
              (r = r.substring(n.length + i.length + 1, r.lastIndexOf("/"))),
                (s = r.split("/").concat(e.split("/")));
            }
            const a = [];
          ...
          l = (e) => {
            ...
            if ("string" == typeof e && e.length < 6) {
              ...
              if ("true" === t) return !0;
              if ("false" === t) return !1;
              if (!(0, i.i2)(Number(e)) && !(0, i.i2)(parseFloat(e)))
                return Number(e);
            }
            return e;
          },
          ...
          u = (e, t) => {
            if (
              ((0, i.i2)(e) && (e = parseInt(e.toString(), 10)),
              (0, i.i2)(e) || !isFinite(e) || (e <= 0 && !t))
            )
              return "00:00";
            const n = e < 0 ? "-" : "";
            e = Math.abs(e);
        ...
        const b = (e, t, n) => {
          ...
          O = (e, t) => {
            if (
              ...
              e.handlers.init || e.handlers.select)
            )
              return;
            const { el: n } = e;
            j(e, t, "blur", () => {
        ...
        const A = T.Date,
          ...
          q = function (e, t, n, r) {
            ...
            if ((null == e && (e = []), f && e.reduce === f))
              return r && (t = R(t, r)), i ? e.reduce(t, n) : e.reduce(t);
            if (
              (S(e, function (e, o, s) {
      ...
      6601: (e, t, n) => {
        ...
        n.d(t, { i: () => r });
        const r =
          "8.26.8+commercial_master.525.hls.js@1.2.9.jwplayer@mono.jwplayer-ads-dai@mono.jwplayer-ads-freewheel@mono.jwplayer-ads-googima@mono.jwplayer-ads-header-bidding@github:jwplayer/jwplayer-ads-header-bidding#v7.1.0.jwplayer-ads-vast@mono.jwplayer-analytics@v3.42.0.jwplayer-analytics-kraken@v0.0.4.jwplayer-plugin-gapro@mono";
      },
      4225: (e, t, n) => {
        "use strict";
        n.d(t, { Z: () => o });
      ...
      7010: (e, t, n) => {
        ...
        function r() {
          return (
            ...
            e.location !== e.parent.location && /isAMP/.test(t)
          );
          var e, t;
        }
      },
...
var jwDefaults = {
  ...
  displaytitle: true,
  height: 270,
  key: "7EmIm5Y/RRvz+pDKxWoOfNJqASwypXp0Mt84/bGht/LTijOY6A3NWOKHIxA=",
  mute: false,
  ph: 1,
  pid: "qYa69P6O",
