!(function () {
  ...
  var V =
    ...
    function (e) {
      for (
        var a = arguments.length, t = Array(1 < a ? a - 1 : 0), n = 1;
        n < a;
        n++
      )
        t[n - 1] = arguments[n];
      ...
      (e.playerData.playerSize = (function (e) {
        ...
        return (
          ...
          /\d+%/.test(a.width || t) && a.aspectratio
            ? { bucket: je, width: t, height: n }
            : Ee(e.getContainer(), "jw-flag-audio-player")
            ? { bucket: Be, width: t, height: n }
            : 0 === t
            ? { bucket: Re, width: t, height: n }
            : t <= 320
            ? { bucket: Ce, width: t, height: n }
            : t <= 640
            ? { bucket: Ae, width: t, height: n }
            : { bucket: xe, width: t, height: n }
        );
      })(n)),
    ...
    (_e.prc = function (e) {
      return (function () {
        ...
        if ("function" == typeof e)
          for (a = 0; a < 1e3; a++) if (!e(a).uniqueId) return a;
        return a;
      })();
    }),
    (_e.ps = function (e) {
  ...
  (Ke.pei = function (e) {
    ...
    V(Ke, ze);
  var We = { aes: 1, widevine: 2, playready: 3, fairplay: 4 };
  var He = {
    interaction: 1,
    autostart: 2,
    repeat: 3,
  ...
  var $e = { none: 1, metadata: 2, auto: 3 };
  function Je(e) {
    return e === 1 / 0
      ? 1 / 0
      : (e |= 0) <= 0
  ...
  (Ze.st = function (e) {
    ...
    (Ze.drm = function (e) {
      return (
        ((a = e.playlistItemData.drm) ? We[a] || 999 : 0) ||
    ...
    fa = function (e, a, t, n) {
      ...
      for (u = c ? u : u[Symbol.iterator](); ; ) {
        ...
        if (
          "rtp" === p &&
          p in i.paramData &&
          (delete i.paramData.rtp.value.decisionThresholds, (o = pa(i)) <= 8192)
        )
          return i.url;
      }
      var f = l,
  ...
  function va(e) {
    ...
    (e.trackingState.pageLoaded = t) ||
      ((e.trackingState.boundFlushQueue = ma.bind(null, e)),
  ...
  function ya(e, a) {
    ...
    t.src = a;
    for (
      var n = e.trackingState.images, r = n.length;
      r-- && (n[r].width || n[r].complete);
  ...
  var ba = { delaySend: !1, returnURL: !1 };
  function ha(t, e) {
    var a =
    ...
    if (
      ...
      return n.delaySend
        ? ga.bind(null, t, o)
        : n.returnURL
        ? fa(o.event, o.bucket, o.parameters, o.pingDestination)
        : void ga(t, o);
    }
  }
  function ka(e) {
    ...
    e.bidders.forEach(function (e) {
      ...
      (r[a.toLowerCase()] =
        ...
        U.forEach(function (e) {
          ...
          "result" === e
            ? (n.result = S[t[e]])
            : V(n, void 0 !== t[e] ? (((a = {})[e] = t[e]), a) : void 0),
            t.code &&
  ...
  function Pa(e, a) {
    ...
    n > t.previousQuartile &&
      (Da(e, a), ha(e, "v", "clienta"), (t.previousQuartile = n));
  }
  var Ea = {
    ...
    adTime: function (e, a) {
      ...
      !n ||
        ...
        i.visibleEvent.canSendPing(se) &&
          ...
          (ha(e, se, "clienta"), i.visibleEvent.setPingSent(se)),
        i.visibleEvent.canSendPing(ce) &&
          2 <= r.maxConsecutiveVisibleSeconds &&
          (ha(e, ce, "clienta"), i.visibleEvent.setPingSent(ce)),
        ...
        function (e) {
          ...
          (a = r),
            "adClick" === (t = e).type ||
              ...
              ((i.ads.adEventData = V({ adId: e.id }, N)),
            ...
            e.type in Ea
              ? Ea[e.type](i, e)
              : -1 === E.indexOf(e.type) && ha(i, P[e.type], "clienta");
        }
      );
  }
  function Aa(e) {
    ...
    "function" == typeof navigator.sendBeacon &&
      ...
      (t = function () {
        g(a, ae);
        var e = ha(a, ae, "jwplayer6", { returnURL: !0 });
    ...
    return function (e) {
      ...
      s === Va &&
        ...
        "flash_adaptive" === v(r)
          ? !c.meta.playbackSent &&
            n.segmentReceived &&
            ((c.meta.playbackSent = !0), (n.segmentReceived = !1), La(c))
          : c.meta.playbackSent || ((c.meta.playbackSent = !0), La(c)));
    };
  }
  function Ga(e) {
  ...
  function qa(e, a, t, n) {
    a < n &&
      n <= a + t &&
      ((e.meta.playbackTracking.retTimeWatched = n), ha(e, "ret"));
  }
  function Na(e, a, t) {
    var n,
      r,
    ...
    i
      ? (function (e) {
          ...
          if (Ba(a)) {
            ...
            var t = ha(e, "vs", "jwplayer6", { delaySend: !0 });
      ...
      : ((t = e.meta.seekTracking),
        (n = a),
        (r = o),
        Ba(t) || ((t.videoStartDragTime = r), (t.dragStartTime = Date.now())),
        t.numTrackedSeeks++,
  ...
  function Ua(e, a, t) {
    ...
    (e.playerData.lastErrorCode[a] = t.code),
      ...
      e.errors.numberEventsSent < e.errors.NUM_ERRORS_PER_SESSION &&
        ...
        ((e.errors.numberEventsSent += 1), ha(e, a, Q));
  }
  var _a = n,
    Qa = t,
    za = a,
  ...
  function Ha(v) {
    var e,
      ...
      t = function (e, a) {
        ...
        t &&
          t === we(a.item) &&
          ((e.playerData.lastErrorCode[J] = a.code), ha(e, "paf", "error"));
      }.bind(null, v);
    g.on("idle buffer play pause complete error", function (e) {
      ...
      g.on("playlistItem", function (e) {
        var a = v.playlistItemData;
        (a.drm = ""),
          0 !== v.meta.playbackTracking.playSessionSequence &&
            (a.itemId = L(12)),
        ...
        r && ((a.mediaId = we(r)), Te(v, r)),
          a.ready &&
            ((v.meta.playbackTracking.posterVideoThumbnail = Ie(e.item)),
            (t = v),
            (n = a.ready),
          ...
          g.once("beforePlay", i),
          Wa(v),
          (v.meta.playbackTracking.segmentReceived =
            v.meta.playbackTracking.segmentsEncrypted =
              !1);
      }),
            ...
            var c,
              ...
              f =
                ...
                c.playerData.viewable &&
                  (s.viewablePlayedSeconds = s.viewablePlayedSeconds + p),
                !c.playerData.muted &&
                  0 < c.playerData.volume &&
                  (s.audiblePlayedSeconds = s.audiblePlayedSeconds + p),
                p);
            if (
              (qa(v, t.playedSecondsTotal, f, 10),
              qa(v, t.playedSecondsTotal, f, 30),
              qa(v, t.playedSecondsTotal, f, 60),
              (t.playedSecondsTotal = t.playedSecondsTotal + f),
              !0 === t.sendSetTimeEvents &&
                (Na(v, n, 3), Na(v, n, 10), Na(v, n, 30)),
              r <= 0 || r === 1 / 0)
            )
              t.playedSeconds >= b && ((t.latency = e.latency), Ga(v));
          ...
          e.on("nextShown", function (e) {
            (a.related.nextShownReason = e.reason),
              ...
              ("hover" !== e.reason || a.related.sendHoverPing) &&
                ((a.related.sendHoverPing = !1), Ja(a, e, Y));
          }),
  ...
  function st(e, a, t) {
    ...
    if (l) ot && ot.removeItem("jwplayerLocalId");
      ...
      var s = (function () {
        if (!ot) return { localID: null, storageAvailable: "fail" };
        var e = ot.jwplayerLocalId;
        if (e) return { localID: e, storageAvailable: "read" };
        try {
          return (
            (ot.jwplayerLocalId = L(12)),
            { localID: ot.jwplayerLocalId, storageAvailable: "set" }
          );
        } catch (e) {
    ...
    return {
      ...
      playerData: {
        ...
        localization: {
          language: r.language,
          numIntlKeys:
            "object" == typeof r.intl ? Object.keys(r.intl).length : null,
          numLocalKeys:
            "object" == typeof r.localization
              ? Object.keys(r.localization).length
              : null
        },
      ...
      configData:
        ...
        (I = {
          ...
          advertisingBlockType:
            ((D = k), D.advertising ? (D.advertising.outstream ? 2 : 1) : 0),
      ...
      placementData:
        ((h = a.placement),
        { embedId: h && h.embedId, placementId: h && h.placementId }),
      browser: {
        langAttr: f,
        isPageStandalone: m,
        docReferrer: v,
      ...
      meta: {
        ...
        playerRemoved: !1,
        pingLimiters: { playlistItem: new dt() },
        sessionSampled: x
      },
      playlistItemData: {
        ready: void 0,
      ...
      ads: {
        ...
        pingLimiters: { visibleEvent: new dt() }
      },
      errors: {
        SAMPLE_RATE: 0.02,
      ...
      var n,
        ...
        i = (function (e) {
          ...
          if (a) {
            ...
            if (t) return { placementId: t, embedId: L(12) };
          }
        })(e.getContainer());
      (r = a),
        (n = i) &&
          (r.placement = { embedId: n.embedId, placementId: n.placementId });
      var o,
        d,
        l,
        u = st(e, a, t);
      Aa((o = u)),
        ...
        (this.getTrackingPixelURLs =
          ...
          function (e, a) {
            ...
            var t = ha(d, "vci", "clienta", { returnURL: !0 }),
              n = ha(d, "vcae", "clienta", { returnURL: !0 });
            return (
              (d.ads.headerBiddingCacheData.bidder = void 0),
              (d.ads.headerBiddingCacheData.cacheKey = void 0),
              { impression: t, error: n }
            );
          })),
